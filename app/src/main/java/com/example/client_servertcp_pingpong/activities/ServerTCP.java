...
public class ServerTCP extends AppCompatActivity {
    ...
    TextView tvStatus, tvEscolha, tvAviso, tvInfoServer, tvEsperaServer, tvNumConectados;
                ...
                for (Network minhaRede : networks) {
                    ...
                    if (netInfo.getState().equals(NetworkInfo.State.CONNECTED)) {
                        ...
                        if (propDaRede.hasTransport(NetworkCapabilities.TRANSPORT_WIFI)) {
                            ...
                            tvStatus.setText("Ativo em: " + ipAddress + ":9090");
    ...
    public void ligarServerCodigo() {
        ...
        try {
            ...
            while (continuarRodando) {
                ...
                //jogadorServer.setCEP(CEPvalido);
                ...
                if(jogadorServer.getCEP() != null && jogadorServer.getCEPOponente() != null){
                    if(jogadorServer.getCEP() != "" && jogadorServer.getCEPOponente() != "") {
            ...
            public void run() {
                try {
                    if (socketOutput != null){
                        ...
                        socketOutput.writeUTF("CEP"+jogadorServer.getCEP());
                        socketOutput.flush();
                    } else {
                        Log.v("PDM", "else");
